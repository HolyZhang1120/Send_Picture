...
u8 USART3_RX_BUF1[USART3_MAX_RECV_LEN]; 				//接收缓冲,最大USART3_MAX_RECV_LEN个字节.
...
//        RingBuffer_In(USART3_RX_BUF1, &Res, 1);            //放入缓存
//    }
//}

void USART3_IRQHandler(void)
{
//	u8 *USART3_RX_BUF1 = NULL;
	u8 res;	
